...
<i class="lni lni-cart"></i>
 <span class="total-items t_item">2</span>
</a>

<div class="shopping-item">
<div class="dropdown-cart-header">
<span class="2_Items"></span>
...
<ul class="shopping-list">
    ...
    <li class="item_cart">
    <a href="javascript:void(0)" product_id="{{ $cart->products[0]->id }}" class="remove del_cart" title="Remove this item"><i class="lni lni-close"></i></a>
    <div class="cart-img-head">
    <a class="cart-img" href="product-details.html">
        <img src="{{asset('storage/images/'.$cart->products[0]->images[0]->files)}}" alt="#">
    </a>
    </div>
    <div class="content">
    <h4><a href="product-details.html">
    {{ $cart->products[0]->name }}</a></h4>
    <p class="quantity"><span class="_count">{{ $cart->count }}</span>x - $<span class="amount">{{ $cart->products[0]->price }}</span></p>
    </div>
    </li>
    @empty
